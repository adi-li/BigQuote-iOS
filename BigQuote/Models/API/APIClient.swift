...
class APIClient: NSObject {
    ...
    func taskForMethod(method: Method, endpoint: String, parameters: Parameters?, completion: CompletionHandler?) -> NSURLSessionTask? {
        ...
        do {
            try request = requestWithURL(URL, parameters: parameters ?? Parameters(), method: method)
        } catch let error {
    ...
    func taskForGET(endpoint: String, parameters: Parameters?, completion: CompletionHandler?) -> NSURLSessionTask? {
        return taskForMethod(.GET, endpoint: endpoint, parameters: parameters, completion: completion)
    }
    
    // Short-hand for POST request
    func taskForPOST(endpoint: String, parameters: Parameters?, completion: CompletionHandler?) -> NSURLSessionTask? {
        return taskForMethod(.POST, endpoint: endpoint, parameters: parameters, completion: completion)
    }
    
    // Short-hand for PUT request
    func taskForPUT(endpoint: String, parameters: Parameters?, completion: CompletionHandler?) -> NSURLSessionTask? {
        return taskForMethod(.PUT, endpoint: endpoint, parameters: parameters, completion: completion)
    }
    
    // Short-hand for DELETE request
    func taskForDELETE(endpoint: String, parameters: Parameters?, completion: CompletionHandler?) -> NSURLSessionTask? {
    ...
    func requestWithURL(URL: NSURL, parameters: Parameters, method: Method) throws -> NSURLRequest {
    ...
    func addAdditionalHeaderToRequest(request: NSMutableURLRequest) {
        ...
        request.setValue("BigQuote/1.0 (Mobile;)", forHTTPHeaderField: "User-Agent")
    }
